var app = (function () {
    ...
    /* webviews/components/File.svelte generated by Svelte v3.48.0 */

    const file$2 = "webviews/components/File.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(/*name*/ ctx[0]);
    			set_style(span, "background-image", "url(https://bhscanner.s3.amazonaws.com/iconsnew/" + /*type*/ ctx[1] + ".svg)");
    			attr_dev(span, "class", "svelte-9d81kn");
    			add_location(span, file$2, 5, 0, 88);
    		},
    ...
    /* webviews/components/Folder.svelte generated by Svelte v3.48.0 */
    const file$1 = "webviews/components/Folder.svelte";
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", "svelte-wylmm5");
    			add_location(ul, file$1, 16, 1, 284);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(20:4) {#if file.type === 'folder'}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			t = space();
    			attr_dev(li, "class", "svelte-wylmm5");
    			add_location(li, file$1, 18, 3, 350);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-wylmm5");
    			toggle_class(span, "expanded", /*expanded*/ ctx[0]);
    			add_location(span, file$1, 13, 0, 214);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t0 = text("You have not yet signed with GitHub\n");
    			button = element("button");
    			button.textContent = "Sign in";
    			add_location(button, file, 121, 0, 3344);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container svelte-1v4hmoi");
    			add_location(div0, file, 106, 1, 3013);
    			add_location(button, file, 110, 2, 3133);
    			attr_dev(div1, "class", "fixed-footer svelte-1v4hmoi");
    			add_location(div1, file, 109, 1, 3104);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Scanning...";
    			add_location(div, file, 104, 0, 2973);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance($$self, $$props, $$invalidate) {
    			...
    			switch (message.type) {
    				case "token":
    					try {
    						...
    						$$invalidate(2, user = userInfo);

    						user === null || user === void 0
    						? void 0
    						: $$invalidate(2, user.githubId = userInfo[0].github_id, user);

    						user === null || user === void 0
    						? void 0
    						: $$invalidate(2, user.id = userInfo[0].id, user);

    						user === null || user === void 0
    						? void 0
    						: $$invalidate(2, user.name = userInfo[0].name, user);
    	...
    	return [accessToken, loading, user, root, click_handler, click_handler_1];
    }
